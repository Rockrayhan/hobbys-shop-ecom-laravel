                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center mt-2">
                                                    ...
                                                    <button
                                                        class="btn btn-sm btn-outline-secondary rounded-circle increase-qty">+</button>
                            ...
                            <form action="{{ route('checkout.place') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg rounded-3" name="phone"
                                        id="phone" placeholder="e.g. 017XXXXXXXX" required>
                                </div>

                                <div class="mb-3">
                                    <label for="address" class="form-label fw-semibold">Delivery Address</label>
                                    <textarea class="form-control form-control-lg rounded-3" name="address" id="address" rows="3"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateTotals() {
                ...
                placeOrderBtn.disabled = cartData.length === 0;
            }
